            ...
            Measurement, OverviewMap, BasemapGallery, Basemap, BasemapLayer, Scalebar, Search, HomeButton, Legend, LocateButton, FeatureLayer, ArcGISDynamicMapServiceLayer, WMSLayer, WMSLayerInfo
                ...
                function dameGeomEtrs89() {
                    ...
                    gsvc.project(params, function (rtdos) {
                        ...
                        //descargarArchivo(generarTextoFromGeom(geometry), prefijo + fecha2 + '.txt');
                        tb.deactivate();
                ...
                function dameCoord4326() {
                    ...
                    gsvc.project(params, function (projectedPoints) {
                        ...
                        dom.byId("label3d").href = "https://www.aragon.es/estaticos/GobiernoAragon/Organismos/InstitutoAragonesGestionAmbiental/StaticFiles/cartografia/INAGA_3d.html?x=" + pt.x.toFixed(5) + "&y=" + (pt.y.toFixed(5) - 0.03);
                    });
                }
                function dameCoord25830() {
                    var outSR = new esri.SpatialReference(25830);
                    var params = new esri.tasks.ProjectParameters();
                    ...
                    gsvc.project(params, function (projectedPoints) {
                        pt = projectedPoints[0];
                        //dom.byId("info").innerHTML = "<b>UTM ETRS89 Huso 30N<br/>x:" + pt.getCenter().x.toFixed(0) + " y:" + pt.getCenter().y.toFixed(0) + "</b> <hr/>Escala: 1:" + Math.round(map.getScale(), 0).toLocaleString('de-DE') + "</br></br>";
                        dom.byId("sitar").href = "https://idearagon.aragon.es/visor/index.html?BOX=" + pt.xmin.toFixed(0) + ":" + pt.ymin.toFixed(0) + ":" + pt.xmax.toFixed(0) + ":" + pt.ymax.toFixed(0);
                        dom.byId("enlaceCapturaCoordenadas").href = "https://www.aragon.es/estaticos/GobiernoAragon/Organismos/InstitutoAragonesGestionAmbiental/StaticFiles/cartografia/INAGA_CapturaCoordenadas.html?zoomEnvelope=" + pt.xmin.toFixed(0) + ":" + pt.ymin.toFixed(0) + ":" + pt.xmax.toFixed(0) + ":" + pt.ymax.toFixed(0);
                        dom.byId("enlaceParticipacion_Publica").href = "https://www.aragon.es/estaticos/GobiernoAragon/Organismos/InstitutoAragonesGestionAmbiental/StaticFiles/cartografia/INAGA_Participacion_Publica.html?zoomEnvelope=" + pt.xmin.toFixed(0) + ":" + pt.ymin.toFixed(0) + ":" + pt.xmax.toFixed(0) + ":" + pt.ymax.toFixed(0);
                        dom.byId("enlaceResolucionesPublicas").href = "https://www.aragon.es/estaticos/GobiernoAragon/Organismos/InstitutoAragonesGestionAmbiental/StaticFiles/cartografia/INAGA_Resolucion_Publica.html?zoomEnvelope=" + pt.xmin.toFixed(0) + ":" + pt.ymin.toFixed(0) + ":" + pt.xmax.toFixed(0) + ":" + pt.ymax.toFixed(0);
                    });
                }
                ...
                function doBuffer(evtObj) {
                    ...
                    // showLoading();
                    //dom.byId("listadoCotos").innerHTML = "";
                ...
                map.on("click", function (evt) {
                    ...
                    if (dom.byId("myonoffswitch").checked) {
                        ...
                        gsvc.project(params, function (projectedPoints) {
                            ...
                            // map.infoWindow.setTitle("Información catastral");
                            ...
                            //popup.setContent("Información catastral<br><a href=" + urlCat + " target='_blank'>Abrir en otra pestaña</a></br></br></href>");                        
                            // cerrar ventana datos
                ...
                map.on("update-end", function () {
                    ...
                    dameCoord4326();
                    dameCoord25830();
                    //console.log(dom.byId("label3d").href);
                });
                ...
                $(document).ready(function () {
                    ...
                    $("#checkSigpac").click(function () {
                        var targetLayer = map.getLayer("SIGPAC");
                        if (targetLayer.visible) {
                            targetLayer.setVisibility(false);
                        }
                        else { targetLayer.setVisibility(true); }
                    ...
                    $("#checkLimites").click(function () {
                        var targetLayer = map.getLayer("Limites");
                        if (targetLayer.visible) {
                            targetLayer.setVisibility(false);
                        }
                        else { targetLayer.setVisibility(true); }
                    ...
                    $("#checkCotos").click(function () {
                        var targetLayer = map.getLayer("Cotos");
                        if (targetLayer.visible) {
                            targetLayer.setVisibility(false);
                        }
                        else { targetLayer.setVisibility(true); }
                    ...
                    $("#checkMontes").click(function () {
                        var targetLayer = map.getLayer("Montes");
                        if (targetLayer.visible) {
                            targetLayer.setVisibility(false);
                        }
                        else { targetLayer.setVisibility(true); }
